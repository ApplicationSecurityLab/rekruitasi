...
@section('content')
    ...
    <div class="container">
        ...
        <hr>
        <iframe width="100%" height="565" src="https://www.youtube.com/embed/Fbo72wJL9DA" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
        <hr>
